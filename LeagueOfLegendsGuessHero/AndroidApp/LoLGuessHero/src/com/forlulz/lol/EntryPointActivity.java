...
import com.forlulz.lol.util.ExpansionAPK;
import com.forlulz.lol.util.SampleDownloaderService;
 ...
 */
public class EntryPointActivity extends Activity implements IDownloaderClient {
    ...
    /**
     * Used to not validate delivered files every time. We do it only once
     */
    private boolean mValidationDone;
    ...
    public void onDownloadProgress(DownloadProgressInfo progress) {
        ...
        // Log.d(LOG_TAG, progress.mOverallProgress + " " +
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mValidationDone = settings.getBoolean(getString(R.string.expansion_validated), false);
        ...
        if (!expansionFilesDelivered()) {
            // either files were deleted or new version must be downloaded
            mValidationDone = false; 
            try {
                Intent intentToLaunchThisActivityFromNotification = getLaunchIntent();
                ...
                if (startResult != DownloaderClientMarshaller.NO_DOWNLOAD_REQUIRED) {
                    ...
                    // show progress
                    // when download complete it will trigger
                    // validateXAPKZipFiles method
                    return;
                }
    ...
    protected void onStop() {        
        ...
        editor.putBoolean(getString(R.string.expansion_validated), mValidationDone);
    ...
    private boolean expansionFilesDelivered() {
        for (ExpansionAPK xf : ExpansionAPK.expansions) {
            String fileName = Helpers.getExpansionAPKFileName(this, xf.isMain(), xf.getFileVersion());
            if (!Helpers.doesFileExist(this, fileName, xf.getFileSize(), false)) {
                return false;
            }
        }
        return true;
    ...
    /**
     * Creating intent to launch application from notification
     * 
     * @return intent to launch application from notification
     */
    private Intent getLaunchIntent() {
        ...
        return intentToLaunchThisActivityFromNotification;
    }
    ...
    private void validateXAPKZipFiles() {
        AsyncTask<Object, DownloadProgressInfo, Boolean> validationTask = new AsyncTask<Object, DownloadProgressInfo, Boolean>() {
            ...
            protected Boolean doInBackground(Object... params) {
                for (ExpansionAPK xf : ExpansionAPK.expansions) {
                    String fileName = Helpers.getExpansionAPKFileName(EntryPointActivity.this, xf.isMain(),
                            xf.getFileVersion());

                    if (!Helpers.doesFileExist(EntryPointActivity.this, fileName, xf.getFileSize(), false)) {
                        return false;
                    }

                    fileName = Helpers.generateSaveFileName(EntryPointActivity.this, fileName);
                    ...
                    try {
                        ...
                        // TODO: workaround
                        totalCompressedLength = totalUncompressedLength;
            ...
            /**
             * This will happen when validation finished
             */
            @Override
            protected void onPostExecute(Boolean result) {
                if (result) {
                    mValidationDone = true;
                    mDashboard.setVisibility(View.VISIBLE);
                    mCellMessage.setVisibility(View.GONE);
        ...
        Log.d(LOG_TAG, "Validation was already done: " + mValidationDone); 
        if (!mValidationDone) {
